...
class PumpFoilEnvCurriculum(gym.Env):
    ...
    def __init__(
        ...
        # Action space: [leg_amplitude, leg_phase_offset, left_arm, right_arm, waist]
    ...
    def step(
        ...
        # Arms and waist always agent-controlled
    ...
    def _compute_reward(
        ...
        reward += pumping_reward + amplitude_reward + frequency_reward  # Pumping incentive
